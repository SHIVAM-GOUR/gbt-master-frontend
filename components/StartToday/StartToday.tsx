...
export default function StartToday() {
  return (
    <section className= "relative bg-black dark:bg-white dark:text-black text-white py-16 px-6 md:px-40">
          <div className="absolute w-[600px] h-[600px] bg-green-20 rounded-3xl blur-[100px] opacity-20  z-0 bottom-0 left-0 max-w-3xl"></div>
