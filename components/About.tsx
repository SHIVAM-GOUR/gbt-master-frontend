...
export default function About() {
  return (
    <section id="about" className="relative bg-black text-white px-6 md:px-40 py-24 overflow-hidden">
      
   
      <div className="absolute right-40 top-2 hidden md:block opacity-100">
